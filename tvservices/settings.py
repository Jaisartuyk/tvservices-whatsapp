...
INSTALLED_APPS = [
    ...
    'subscriptions.apps.SubscriptionsConfig',  # Reactivado para evitar errores de migración
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Activado para Railway
...
# Static files storage - Whitenoise para Railway
